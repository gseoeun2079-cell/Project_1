...
if st.session_state.page == '첫화면':
    ...
    selected_option2 = st.selectbox("국물이 있는 음식을 원하시나요?",("국물O","국물X"))
    selected_option3 = st.selectbox("매운 음식을 원하시나요?",("매운맛O","매운맛X","상관없음"))
    selected_option4 = st.selectbox("시원한 음식을 원하시나요, 따뜻한 음식을 원하시나요?",("시원한 음식","따뜻한 음식"))
    selected_option5 = st.selectbox("밥 종류의 음식을 원하시나요, 면 종류의 음식을 원하시나요?",("밥 종류의 음식","면 종류의 음식"))
    selected_option6 = st.selectbox("기름진 음식을 원하시나요, 깔끔한 음식을 원하시나요?",("기름진 음식","깔끔한 음식"))
